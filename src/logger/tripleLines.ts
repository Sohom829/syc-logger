...
const renderTripleLines = (amount: number, color: string = "#FFFFFF") => {
...
const renderTripleLinesAsync = (amount: number, color: string = "#FFFFFF") => {
  const Color = chalk.hex(`${color}`) || null;
  if (amount === 1) {
    return Color(line);
  } else if (amount === 2) {
...
export { renderTripleLines, renderTripleLinesAsync };
