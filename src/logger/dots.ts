...
const renderDots = (amount: number, color: string = "#FFFFFF") => {
  ...
  if (amount === 1) {
    ...
    console.log(Color(line + line + line));
  } else if (amount === 4) {
    console.log(Color(line + line + line + line));
  } else if (amount === 5) {
    console.log(Color(line + line + line + line + line));
  } else if (amount === 6) {
    console.log(Color(line + line + line + line + line + line));
  } else if (amount === 7) {
    console.log(Color(line + line + line + line + line + line + line));
  } else if (amount === 8) {
    console.log(Color(line + line + line + line + line + line + line + line));
  } else if (amount === 9) {
    console.log(
      Color(line + line + line + line + line + line + line + line + line)
    );
  } else if (amount === 10) {
    console.log(
      Color(line + line + line + line + line + line + line + line + line + line)
    );
  } else if (amount === 11) {
    console.log(
      Color(
...
const renderDotsAsync = (amount: number, color: string = "#FFFFFF") => {
  const Color = chalk.hex(`${color}`) || null;
  if (amount === 1) {
    return Color(line);
  } else if (amount === 2) {
    ...
    throw new ReferenceError("Maximum amount of dots is 40.");
  }
};

export { renderDots, renderDotsAsync };
