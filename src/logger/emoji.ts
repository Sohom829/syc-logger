...
const logEmoji = (message: any, style: number = 1, color: string = "#FFFFFF", emoji: string = "✅") => {
...
const logEmojiAsync = (message: any, style: number = 1, color: string = "#FFFFFF", emoji: string = "✅") => {
  const Color = chalk.hex(`${color}`);
  if(style === 1) {
